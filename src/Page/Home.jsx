...
const Home = () => {
  ...
  return (
    <div className='hero overflow-hidden p-[35px] mt-[150px] md:mt-[200px]w-full flex flex-col gap-10 md:gap-10 items-center justify-center'>
      ...
      className='heroH text-center md:w-[709px] h-[186px md:h-[196px] lg:text-[80px] sm:text-[60px]  xs:text-[50px] text-[40px] leading-[62px] md:leading-[88px] tracking-[0.2px] md:font-bold'
      >
        ...
        data-aos-delay="600"
        data-aos-easing="linear"
        className='heroS mt-[10px] text-center md:mt-3 text-[20px] sm:w-[382px] sm:h-[120px]'
        >
        ...
        <div className=''>
          <img
           ...
           data-aos-easing="linear"
           data-aos-duration='500'
           src={screens} alt="screen image"  className='w-screen'/>
        </div>
    </div>
  )
}
